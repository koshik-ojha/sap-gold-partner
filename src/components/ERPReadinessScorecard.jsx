...
import { CheckCircle, AlertTriangle, XCircle, ArrowRight, ArrowLeft, BarChart3, Clock, PoundSterling, TrendingUp, Package, FileText, Users, Zap, Calendar, Mail, ChevronDown, Sparkles } from 'lucide-react';

const ERPReadinessScorecard = ({ embedded = false, onClose }) => {
        ...
        <div className={embedded ? "w-full" : "max-w-2xl w-full"}>
          <div className={cardClass}>
            <div className="bg-gradient-to-r from-orange-600 to-amber-500 p-6 text-white text-center">
              ...
              <h1 className="text-2xl font-bold mb-1">ERP Readiness Scorecard</h1>
              <p className="text-orange-100 text-sm">Is your current system holding back your business?</p>
            </div>
            ...
            <div className="p-6">
              ...
              <div className="grid grid-cols-3 gap-3 mb-6">
                <div className="text-center p-3 bg-gray-50 rounded-xl">
                  <p className="text-xl font-bold text-orange-600">2 min</p>
                ...
                <div className="text-center p-3 bg-gray-50 rounded-xl">
                  <p className="text-xl font-bold text-orange-600">Free</p>
              ...
              <button
                ...
                className="w-full py-3 bg-gradient-to-r from-orange-600 to-amber-500 text-white rounded-xl font-semibold hover:from-orange-700 hover:to-amber-600 transition-all flex items-center justify-center gap-2 shadow-lg"
              >
                Start Assessment
                <ArrowRight size={18} />
              </button>
              ...
              {embedded && onClose && (
                <button
                  onClick={onClose}
                  className="w-full mt-3 text-orange-600 hover:text-orange-700 text-sm"
                >
                  ← Back to overview
                </button>
              )}
            ...
            <div className="p-6">
              ...
              <div className="flex items-start gap-3 mb-6">
                <div className="p-2 bg-orange-100 rounded-lg flex-shrink-0">
                  <q.icon className="text-orange-600" size={20} />
                </div>
              ...
              <div className="space-y-2">
                {q.options.map((option, i) => (
                  <button
                    ...
                    className="w-full p-3 text-left border-2 border-gray-200 rounded-xl hover:border-orange-500 hover:bg-orange-50 transition-all group"
                  >
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="font-medium text-gray-800 group-hover:text-orange-700 text-sm">
                          {option.label}
                        </p>
              ...
              {currentQuestion > 0 && (
                <button
                  ...
                  className="mt-4 flex items-center gap-2 text-gray-500 hover:text-gray-700 text-sm"
                >
                  <ArrowLeft size={14} />
                  Previous question
                </button>
  ...
  if (currentStep === 'contact' && !showResults) {
    return (
      <div className={wrapperClass}>
        <div className={embedded ? "w-full" : "max-w-2xl w-full"}>
          <div className={cardClass}>
            <div className="bg-gradient-to-r from-orange-600 to-amber-500 p-5 text-white text-center">
              <Sparkles size={28} className="mx-auto mb-2" />
              <h2 className="text-xl font-bold">Your Results Are Ready!</h2>
              <p className="text-orange-100 text-sm">Enter your details to see your personalised report</p>
            </div>
            
            <form onSubmit={handleContactSubmit} className="p-6">
              <div className="space-y-3 grid grid-cols-1 md:grid-cols-2 gap-4 text-start">
                <div>
                  ...
                  <input
                    ...
                    className="w-full p-2.5 border border-gray-200 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent text-sm placeholder:text-gray-400"
              ...
              <button
                type="submit"
                className=" mt-5 py-3 px-6 mx-auto bg-gradient-to-r from-orange-600 to-amber-500 text-white rounded-xl font-semibold hover:from-orange-700 hover:to-amber-600 transition-all flex items-center justify-center gap-2"
              >
                View My Results
                <ArrowRight size={18} />
              </button>
  ...
  if (currentStep === 'results') {
    ...
    return (
      <div className={embedded ? "w-full space-y-4" : "min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 py-8 px-4"}>
        <div className={embedded ? "w-full" : "max-w-3xl mx-auto"}>
          {/* Header Card */}
          <div className={`${cardClass} ${embedded ? '' : 'mb-6'}`}>
            <div className={`${category.bgColor} p-6 text-center border-b-4 ${category.borderColor}`}>
              <div className={`inline-flex items-center justify-center w-16 h-16 rounded-full bg-white shadow-lg mb-3`}>
                <CategoryIcon className={category.textColor} size={32} />
              </div>
              <h1 className={`text-2xl font-bold ${category.textColor} mb-1`}>{category.title}</h1>
            ...
            <div className="p-6">
                ...
                <div className="relative">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center">
                      <p className={`text-3xl font-bold ${category.textColor}`}>{score.percentage}%</p>
              ...
              {/* Description */}
              <div className={`p-3 ${category.bgColor} rounded-lg mb-4`}>
                <p className={`${category.textColor} text-sm`}>{category.description}</p>
              </div>
              
              {/* Recommendation */}
              <div className="p-3 bg-gray-50 rounded-lg border-l-4 border-orange-500">
                <p className="font-medium text-gray-800 mb-1 text-sm">Our Recommendation</p>
                <p className="text-gray-600 text-xs">{category.recommendation}</p>
              </div>
            </div>
          </div>

          {/* Category Breakdown */}
          <div className={`${cardClass} ${embedded ? 'mt-4' : 'mb-6'}`}>
            <div className="p-4 border-b border-gray-100">
              <h2 className="text-lg font-bold text-gray-800">Score Breakdown by Area</h2>
            </div>
                  ...
                  <div key={catName}>
                    ...
                    >
                      <div className="flex items-center justify-between mb-1">
                        <span className="font-medium text-gray-700 text-sm">{catName}</span>
                        ...
                        {data.questions.map(q => {
                          ...
                          return (
                            <div key={q.id} className="flex justify-between text-xs">
                              <span className="text-gray-600 pr-2">{q.question}</span>
          ...
          {/* CTA Card */}
          <div className={`bg-gradient-to-r from-orange-600 to-amber-500 ${embedded ? 'rounded-2xl mt-4' : 'rounded-3xl shadow-2xl mb-6'} overflow-hidden p-6 text-white text-center`}>
            <h2 className="text-xl font-bold mb-2">Want to discuss your results?</h2>
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <button className="px-5 py-2.5 bg-white text-orange-600 rounded-lg font-semibold hover:bg-orange-50 transition-all flex items-center justify-center gap-2 text-sm">
                <Calendar size={18} />
                Book Strategy Session
              </button>
              <button className="px-5 py-2.5 bg-orange-700 text-white rounded-lg font-semibold hover:bg-orange-800 transition-all flex items-center justify-center gap-2 text-sm">
                <Mail size={18} />
                Email My Results
              </button>
            </div>
          ...
          {/* Action Buttons */}
          <div className={`flex ${embedded ? 'flex-col sm:flex-row' : ''} gap-3 justify-center mt-4`}>
            <button
